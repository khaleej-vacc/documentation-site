...
- Mach Number restrictions above FL250.
- IAS restrictions during descent sequencing.
- Reductions for spacing into OB**, OMAE and OTDF arrivals.

Unless otherwise instructed, controllers should avoid excessive speed reductions that may negatively affect sequencing efficiency.

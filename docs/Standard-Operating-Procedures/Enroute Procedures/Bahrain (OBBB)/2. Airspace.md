...
| OBBB_CL_CTR        | OBBB_CH_CTR **or** OBBB_1_CTR             | Can be opened without BBCH with prior permission.               |
| OBBB_N_CTR        | OBBB_3_CTR             | Can be opened without BB3 with prior permission.                |
| OBBB_E_CTR        | OBBB_2_CTR             | Can be opened without BB2 with prior permission.                |

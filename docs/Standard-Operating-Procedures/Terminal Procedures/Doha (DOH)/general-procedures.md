...
|--------------|--------------------|---------------------|
| Version 1    | 15JUN26            | Initial Publication |
...
#### 1.2.1 Surveillance-based separation
Aircraft operating within the Doha TMA must maintain a minimum horizontal as presribed in table 1.2-1. If this cannot be achieved, a minimum vertical separation of **1,000FT** must be applied.

<figure markdown>
  <figcaption>Table 1.2-1: Minimum Horizontal Separation (TMA)</figcaption>
</figure>
...
#### 1.2.2 Wake turbulence separation
The applicable Recategorisation Wake Turbulence Separation Minima (**RECAT**) must always be enforced for aircraft operating below **6,000FT** under the following conditions:

- When an aircraft is directly behind another at the same altitude or within **1,000FT** below.  
- When both aircraft are utilizing the same runway or parallel runways separated by less than **760 meters**.  
- When an aircraft is crossing behind another at the same altitude or within **1,000FT** below.  

---

### 1.3 Doha TMA runway configuration
...
### 1.4 Designated areas of responsibility
#### 1.4.1 General
To manage controller workload during peak traffic periods, the **Doha Terminal Maneuvering Area (TMA)** may be sectorized into **a maximum of 6 sectors**. Each sector shall be assigned specific departure and arrival responsibilities and must adhere strictly to standard level assignment, coordination, and handoff procedures to ensure safe and efficient separation of traffic.

- **Doha Radar**  
  Responsible for air traffic within **Doha TMA 3** from **4500FT up to FL245** (Excluding Doha Approach Sectors).

- **Doha Approach**  
  Responsible for air traffic within **Doha TMA 1, 1A, and 2** from **12,000FT down to 2,500FT**  (Excluding Doha Director Sectors).

- **Doha Director**  
  Responsible for managing **downwind traffic** from **4,000FT and below** (Excluding the Doha Control Zone).

#### 1.4.2 Coordination between controllers
...
#### 1.4.3 Connection Hierarchy
Unless explicitly authorized by the Khaleej vACC staff, sectors within the Doha TMA must be opened in the specified order.  
...
#### 1.4.4 Sector top-down coverage

...
### 4.1.1 Airspace
The **Doha Control Zone (CTR)** is **Class D Airspace** from the ground up to 2500FT Mean Sea Level (MSL). The **Tower Controller** is responsible for ensuring all traffic within the Control Zone is separated. This will typically include all IFR Flights departing and arriving as well as VFR Flights operating within the Control Zone or entering and exiting. 


![Hamad CTR](../../../img/OT/DOHA_CTR.png#center)
...
- **Simultaneous Parallel Departures (SPD):** Departures can happen simultaneously on any of the two parallel runways.  
...
### 4.3.1 Doha Recategorisation Wake Turbulence Separation Minima (RECAT)
...
Recategorisation Wake Turbulence Separation Minima (RECAT), the re-categorisation of aircraft is based primarily on maximum take-off mass, wingspan, and approach speed. eWTS splits aircraft into seven categories (A to F), as opposed to the four categories defined in ICAO Doc 4444.
...
### 4.3.2 Departures (time-based separation)
#### 4.3.2.1 Successive full-length departures
<figure markdown>
  <figcaption>Table 4.3.2-1: RECAT departure separation (full-length)</figcaption>
</figure>
...
#### 4.3.2.1 Departure from an intermediate point following departure from full-length
<figure markdown>
  <figcaption>Table 4.3.2.1-1: RECAT departure separation (intermediate point following full-length)</figcaption>
</figure>
<table><thead>
  <tr>
    <th>Follower</th>
...
### 4.4.1 Standard departure points
Below are the points which pilots are recommended to plan for departure.

<figure markdown>
  <figcaption>Table 4.4-1-1: Standard Departure Points</figcaption>
</figure>
...
### 4.4.3 Take-off clearances
Aircraft will be cleared for takeoff once adequate separation is ensured as outlined in section 4.2, pilots should report passing 1000FT, at which point they should be handed off to either Doha Approach East or West, or the next available station, such as Doha Radar or Doha Control. If none of these stations are online, aircraft will be instructed to monitor ADVISORY 122.8.
...
#### 4.4.4.2 Low visibility and IMC
...
#### 4.4.4.3 U.A.E FIR Flow Control
...
<figure markdown>
  <figcaption>Table 4.4.4.3-1: U.A.E FIR Flow Control</figcaption>
</figure>
...
### 4.4.5 IFR handoff procedure
#### 4.4.5.1 General
IFR departures shall be transferred to the next frequency upon passing 1,000 feet, as specified in Section 4.4.3, to allow adequate time for frequency change and to maintain an uninterrupted climb profile..
...
#### 4.4.5.2 Doha Approach hand off procedure
...
### 4.5.1 Standard runway exits
On initial contact, aircraft shall be instructed to vacate at a designated taxiway for arrival. The planned exit point shall be one of the preferred exit taxiways.
...
### 4.5.3 Go-around instruction
#### 4.5.3.1 General go-around procedure
...
#### 4.5.3.2 Go-around with simultaneous departure in IMC or during LVO
...
## 4.6 High Intensity Runway Operation (HIRO)
### 4.6.1 General
...
During HIRO, pilots should only use standard rapid exit taxiways (RET’s) as outlined in the table below and are encouraged to vacate the landing runway within 60 seconds. Pilots unable to comply with HIRO shall advise Tower on first contact.
...
When exiting the runway, pilots shall continue taxi as outlined in table below, unless otherwise instructed by the Tower controller:

| Runway | Taxi Route |
|:------:|:-----------:|
|   16L  |      Continue via A6, hold short of TWY C     |
|   16R  |    Continue southbound on TWY K/M     |
|   34L  |    Continue southbound on TWY K/M<br>**OR**<br>Continue northbound on TWY K if planned stand is north of TWY L6    |
|   34R  |      Continue via A6, hold short of TWY C     |

### 4.6.2 Conditions for the application of HIROs
...
## 4.7 Reduced runway separation minima (RRSM)
### 4.7.1 Conditions for the application of RRSM
...
### 4.7.2 Departure following departure
...
### 4.7.3 Landing following landing
...
### 4.7.4 Landing following departure
When the runway in use is temporarily occupied by other traffic, landing clearance may be issued to an arriving aircraft, provided the controller has reasonable assurance that the following separation distances and criteria will be met when the landing aircraft crosses the runway threshold:
...
## 4.8 Low visibility operations (LVO)
### 4.8.1 Commencement of LVO
...
LVO may be pre-emptively initiated when RVR or meteorological visibility is reported at or below 1500 m and forecast to reduce below LVO minima, or the cloud ceiling is reported as 500FT, and forecast to reduce below LVO minima. 

### 4.8.2 LVO departure procedures
During LVO, aircraft must use CAT II/III holding points for all runways in order to protect ILS-critical areas. 

CAT II/III holding points must be used during LVO for departing aircraft, refer to the table below.
...
## 4.9 Designated areas of responsibility
### 4.9.1 AIR positions
...
### 4.9.3 Splitting procedure
Where there is only one controller, they shall cover all runways and associated airspace from the AIR 1 position. 

Unless otherwise authorised by the Khaleej vACC staff, GMP (Hamad Clearance Delivery) and at least one GMC (Hamad Ground) position must be online before two AIR (Hamad Tower) positions may be opened.

| Position      |       Prerequisite Position      |               Notes                   |
|---------------|--------------------------------|---------------------------------------|
|   OTHH_1_TWR  |           N/A                  |       Bandbox                  |
|   OTHH_2_TWR  |           OTHH_1_TWR,<br>OTHH_1_GND                 |                         |
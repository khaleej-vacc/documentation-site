...
The airspace in the **Kuwait Terminal Maneuvering Area (TMA)** doesn't allow for a lot of maneuverability due to its geographical location and multiple surrounding country borders so aircraft need to be carefully managed in order to ensure safe seperation between arrivals and departures.
...
The **Kuwait Terminal Maneuvering Area (TMA)** is surrounded by Saudi Arabia to the West and Bahrain to the South. As APP Controller in Kuwait you have to work closely with the adjacent controlling units to ensure safe and efficent operations within the TMA. 
...
The 7nm longitudinal separation requirements within the TMA **overides any wake turbulence seperation minima which is lower than the minimum longitudinal seperation requirements.** 
...
> **APP Controller:** _**"KAC505, Identified, continue climb FL150, resume own navigation direct SESRU"**_
...
> **APP Controller:** _**"KAC164, enter the published hold at OBSAS, descend altitude 8000ft, expect 10 minute delay."**_
